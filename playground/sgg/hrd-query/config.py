...
_config_dict = dict(
    ...
    MODEL=dict(
        ...
        #####
        TEST_WEIGHTS="/root/project/sgtr/cvpods//playground/sgg/hgtr-query/hgtr-query/model_0029999.pth",

        WEIGHTS="/root/project/sgtr/cvpods/playground/model_detr_2.pth",
        ...
        REL_DETR=dict(  # relationship DETR
            ...
            TRANSFORMER=dict(
                ...
                NUM_UNION_LAYER=union_dec_layer,
                DIM_FFN=2048,
                DROPOUT_RATE=0.1,
                ACTIVATION="relu",
                PRE_NORM=True,
    ...
    SOLVER=dict(
        ...
        IMS_PER_BATCH=3,  # 四卡时候的batchsize
        IMS_PER_DEVICE=1,
